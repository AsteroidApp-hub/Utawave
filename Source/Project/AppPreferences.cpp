...
AppPreferences AppPreferences::load()
{
    ...
    if (auto xml = juce::XmlDocument::parse(getStoreFile()))
    {
        ...
        p.enableAppCaptureTracks = xml->getBoolAttribute("enableAppCaptureTracks", p.enableAppCaptureTracks);
...
bool AppPreferences::save() const
{
    ...
    xml.setAttribute("enableAppCaptureTracks", enableAppCaptureTracks);
